...
class _$CastImpl implements _Cast {
  ...
  @override
  String toString() {
    return 'Cast(id: $id, name: $name, status: $status, species: $species, type: $type, gender: $gender, origin: $origin, location: $location, episode: $episode, image: $image)';
  }
...
mixin _$Casts {
  ...
  List<Cast> get results => throw _privateConstructorUsedError;
...
abstract class $CastsCopyWith<$Res> {
  ...
  @useResult
  $Res call({Info info, List<Cast> results});
...
class _$CastsImpl extends _Casts {
  _$CastsImpl({required this.info, required final List<Cast> results})
      : _results = results,
        super._();

  @override
  final Info info;
  final List<Cast> _results;
  @override
  List<Cast> get results {
  ...
  @override
  String toString() {
    return 'Casts(info: $info, results: $results)';
  }
...
abstract class _Casts extends Casts {
  factory _Casts(
      ...
      required final List<Cast> results}) = _$CastsImpl;
  _Casts._() : super._();
